...
// ----------------------------------------------------------------------------
// vtkInteractorStyleChannelFragment methods
// ----------------------------------------------------------------------------

function vtkInteractorStyleChannelFragment(publicAPI, model) {
  // Set our className
  model.classHierarchy.push('vtkInteractorStyleChannelFragment');
...
export function extend(publicAPI, model, initialValues = {}) {
  ...
  vtkInteractorStyleChannelFragment(publicAPI, model);
}
...
export const newInstance = macro.newInstance(
  extend,
  'vtkInteractorStyleChannelFragment'
);
