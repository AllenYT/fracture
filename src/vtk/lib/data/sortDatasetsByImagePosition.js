 ...
 * @LastEditTime: 2021-06-10 18:15:38
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \deepln-dazhou-new\src\vtk\lib\data\sortDatasetsByImagePosition.js
 */
...
export default function sortDatasetsByImagePosition(scanAxisNormal, imageMetaDataMap) {
  ...
  const distanceDatasetPairs = datasets.map(function (dataset) {
    const positionVector = vec3.sub([], referenceDataset.imagePositionPatient, dataset.imagePositionPatient)
