...
class CornerstoneElement extends Component {
  ...
  render() {
    ...
    dicomTagPanel = (
      <div>
        <div id="dicomTag">
          <div style={{ position: "absolute", color: "white", top: "5px" }}>
                  ...
                  <Grid.Row>
                    ...
                    <Grid.Column width={1} textAlign="center">
                      <Popconfirm
                        placement="topLeft"
                        title={"确认删除当前结节？"}
                        onConfirm={this.delNodule.bind(this, delId)}
                        id={delId}
                        okText="Yes"
                        cancelText="No"
                      >
    ...
    cornerstone.loadAndCacheImage(imageId).then((image) => {
      ...
      if (initial) {
        ...
        if (document.body.clientWidth > document.body.clientHeight) {
          scale = this.state.crossCanvasWidth / 512;
        } else {
          scale = this.state.verticalCanvasHeight / 512;
        }
        let viewport = {
          invert: false,
