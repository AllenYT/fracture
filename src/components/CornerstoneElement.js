...
import { Grid, Icon, Button, Accordion, Modal, Dropdown, Tab, Image, Menu, Label, Header, List, Popup, Table, Sidebar, Loader } from 'semantic-ui-react'
  ...
  render() {
    ...
    let panes = [
        ...
        render: () => (
          <Tab.Pane>
            <MiniReport
              ...
              activeItem={this.state.doubleClick === true ? 'all' : this.state.listsActiveIndex}
            />
          </Tab.Pane>
        ),
      },
      {
        ...
        render: () => (
          <Tab.Pane>
            <MiniReport type="处理建议" imageIds={this.state.imageIds} boxes={this.state.boxes} />
          </Tab.Pane>
        ),
      },
      // {
