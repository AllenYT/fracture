            ...
            <Grid celled className="corner-contnt">
              <Grid.Row className="corner-row" columns={2}>
                ...
                <Grid.Column width={15} textAlign="center" style={{ position: 'relative' }}>
                  ...
                  {/* </div> */}
                  {visualContent}
                  <button id="closeVisualContent" className="closeVisualContent-vertical" onClick={this.closeVisualContent}>
                    ×
                  </button>
                </Grid.Column>
              </Grid.Row>
    ...
    if (this.props.type === '影像所见') {
      ...
      if (this.props.activeItem === -1) {
        ...
        for (let i = 0; i < this.props.boxes.length; i++) {
          ...
          let represent = ''
          let malignancy = ''
          if (this.props.boxes[i]['place'] === 0 || this.props.boxes[i]['place'] === undefined || this.props.boxes[i]['place'] === '') {
            if (this.props.boxes[i]['segment'] === undefined || this.props.boxes[i]['segment'] === '' || this.props.boxes[i]['segment'] === 'None') {
              place = '未知位置'
            } else {
          ...
          if (this.props.boxes[i]['measure'] !== undefined) {
            ll = Math.sqrt(Math.pow(this.props.boxes[i].measure.x1 - this.props.boxes[i].measure.x2, 2) + Math.pow(this.props.boxes[i].measure.y1 - this.props.boxes[i].measure.y2, 2))
            sl = Math.sqrt(Math.pow(this.props.boxes[i].measure.x3 - this.props.boxes[i].measure.x4, 2) + Math.pow(this.props.boxes[i].measure.y3 - this.props.boxes[i].measure.y4, 2))
            if (isNaN(ll)) {
              ll = 0
            }
            if (isNaN(sl)) {
        ...
        let represent = ''
        let malignancy = ''
        if (this.props.boxes[this.props.activeItem]['place'] === 0 || this.props.boxes[this.props.activeItem]['place'] === undefined || this.props.boxes[this.props.activeItem]['place'] === '') {
          if (
        ...
        if (this.props.boxes[this.props.activeItem]['measure'] !== undefined) {
          ll = Math.sqrt(
            Math.pow(this.props.boxes[this.props.activeItem].measure.x1 - this.props.boxes[this.props.activeItem].measure.x2, 2) +
              Math.pow(this.props.boxes[this.props.activeItem].measure.y1 - this.props.boxes[this.props.activeItem].measure.y2, 2)
          )
          sl = Math.sqrt(
            Math.pow(this.props.boxes[this.props.activeItem].measure.x3 - this.props.boxes[this.props.activeItem].measure.x4, 2) +
              Math.pow(this.props.boxes[this.props.activeItem].measure.y3 - this.props.boxes[this.props.activeItem].measure.y4, 2)
          )
          if (isNaN(ll)) {
            ll = 0
          }
