        ...
        return (
          ...
          >
            ...
            <Sidebar
              animation="overlay"
              direction="right"
              visible={tubularController.tubularActive[index]}
            >
              <div className="segment-list-sidebar-visibility">
                <Button
                  inverted
                  color="blue"
                  size="tiny"
                  hidden={tubularController.tubularVisible[index]}
                  onClick={this.setVisible.bind(this, 1, index, item.index)}
                >
                  显示
                </Button>
                <Button
              ...
              <div className="segment-list-sidebar-opacity">
                <Button
                  ...
                  color="blue"
                  size="tiny"
                  hidden={tubularController.tubularOpacityChangeable[index]}
                  onClick={this.setOpacityChangeable.bind(this, 1, index)}
                >
                  透明度
                </Button>
                <Button
