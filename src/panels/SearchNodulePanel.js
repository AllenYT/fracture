                    ...
                    <Grid inverted divided>
                      ...
                      <Grid.Row>
                        <Grid.Column className="gridLabel inputContainer" widescreen={6} computer={8}>
                          ...
                          <Input id="searchBoxleft" placeholder="cm" onChange={this.handleInputChange} name="left" maxLength={4} type="number" />
                          <em>&nbsp;&nbsp;-&nbsp;&nbsp;</em>
                          <Input id="searchBoxright" placeholder="cm" onChange={this.handleInputChange} name="right" maxLength={4} type="number" />
                          <a
                            style={{
                              marginLeft: 15,
                              color: '#66cfec',
