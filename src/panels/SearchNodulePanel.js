...
export class SearchNodulePanel extends Component {
  ...
  componentDidUpdate(prevProps, prevState) {
    console.log(
      "diameterContainer",
      prevState.diameterContainer,
      this.state.diameterContainer
    );
    ...
    axios
      ...
      .then((response) => {
        ...
        for (const idx in data) {
          ...
          sequence["病人ID"] =
            data[idx]["patienId"] === undefined ? "" : data[idx]["patienId"];
          sequence["性别"] = data[idx]["patientSex"] === "M" ? "男" : "女";
          sequence["年龄"] =
            data[idx]["patientBirth"] === undefined
              ? ""
              : 2020 - parseInt(data[idx]["patientBirth"].slice(0, 4));
          sequence["结节体积(cm³)"] =
            data[idx]["volume"] === undefined
              ? ""
              : Math.floor(data[idx]["volume"] * 100) / 100;
          sequence["结节直径(cm)"] =
            data[idx]["diameter"] === undefined
              ? ""
              : Math.floor(data[idx]["diameter"] * 100) / 100;
          sequence["危险程度"] =
            data[idx]["malignancy"] == 2
              ? "中危"
              : data[idx]["malignancy"] == 3
              ? "高危"
              : "低危";
          ...
          sequence["胸膜凹陷征"] =
            data[idx]["pin"] === undefined
              ...
              : "否";
          sequence["空洞征"] =
            data[idx]["cav"] === undefined
              ? ""
              : data[idx]["cav"] === 2
              ? "是"
              : "否";
          sequence["血管集束征"] =
            data[idx]["vss"] === undefined
              ? ""
              : data[idx]["vss"] === 2
              ? "是"
              : "否";
          sequence["空泡征"] =
            data[idx]["bea"] === undefined
              ? ""
              : data[idx]["bea"] === 2
              ? "是"
              : "否";
          sequence["支气管充气征"] =
            data[idx]["bro"] === undefined
              ? ""
              : data[idx]["cav"] === 2
              ? "是"
              : "否";
              ...
              {Object.entries(nums).map((key, value) => {
                return key[1] !== null ? (
                  <Label as="a" key={value} className="labelTags">
                    ...
                    <Icon
                      name="delete"
                      onClick={this.handleLabelsIcon.bind(this, key[1])}
                      inverted
                      color="green"
                    />
                  </Label>
                ...
                <Grid.Row className="gridRow">
                  ...
                  <Grid.Column width={13} className="gridLabel">
                    <Grid inverted divided>
                      ...
                      <Grid.Row>
                        <Grid.Column
                          className="gridLabel inputContainer"
                          widescreen={6}
                          computer={8}
                        >
            ...
            <Grid.Column verticalAlign="middle" width={4} textAlign="left">
              ...
              {this.state.load === true ? (
                <Button
                  ...
                  className="ui green inverted button"
                  size="mini"
                  onClick={this.handleAddQueues.bind(this)}
                  disabled
                ></Button>
              ) : (
                <Button
