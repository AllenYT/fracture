                  ...
                  <Modal.Content scrolling id="selectGrid">
                    <Grid>
                          ...
                          <Grid.Row>
                            ...
                            <Grid.Column width={14}>
                              <Grid inverted divided>
                                ...
                                <Grid.Row>
                                  <Grid.Column width={16} style={{ display: 'flex', flexDirection: 'row', alignItems: 'center' }}>
                                    <a style={{ color: '#66cfec' }} id="feaDropdown">
                                      自定义：
                                    </a>
                                    <Input className="searchBox" placeholder="cm" onChange={this.handleDiaChange} name="left" maxLength={5} />
                                    <em>&nbsp;&nbsp;-&nbsp;&nbsp;</em>
                                    <Input className="searchBox" placeholder="cm" onChange={this.handleDiaChange} name="right" maxLength={5} />
                                    <a
                                      style={{
                                        marginLeft: 15,
                                        color: '#66cfec',
                      ...
                      <Grid.Row verticalAlign="middle" textAlign="center" centered>
                        <Input name="pid" value={this.state.pidKeyword} onChange={this.handleInputChange} id="pid-search" icon="search" placeholder="病人ID" />
                      </Grid.Row>
                      <Grid.Row centered>
                        <Grid.Column width={7} verticalAlign="middle" textAlign="center">
                          <Grid.Row>
                            {/* loader */}
                            <div class="ui active inverted dimmer" style={{ display: 'none' }} id="loading">
                              <div class="ui text loader">查询中...</div>
                            </div>
                            <select name="left" id="left" className="select-component" multiple="multiple" size="10">
                        ...
                        <Grid.Column width={7} verticalAlign="middle" textAlign="center">
                          <select name="right" id="right" className="select-component" multiple="multiple" size="10">
                      ...
                      <Grid.Row>
                        ...
                        <Grid.Column width={3}>
                          <Button onClick={this.setQueueName} inverted color="blue">
                            新建队列
                          </Button>
                        </Grid.Column>
                      </Grid.Row>
                            ...
                            <Modal
                              ...
                              <div className={'admin-manage-log-block ' + (deleteQueueModalToggleds[index] ? 'admin-manage-log-block-toggled' : '')}>
                                <div className={'admin-manage-log-heading'}>
                                  删除该队列
                                  <FontAwesomeIcon className={'admin-manage-log-heading-icon'} icon={faTimesCircle} onClick={this.setDeleteQueueModalOpen.bind(this, index, false)} />
                                  <FontAwesomeIcon
                                    className={'admin-manage-log-heading-icon'}
                                    icon={deleteQueueModalToggleds[index] ? faChevronCircleDown : faChevronCircleUp}
                                    onClick={this.setDeleteQueueModalToggled.bind(this, index)}
                                  />
                                </div>
                                <Form className={'admin-manage-log-form'} labelCol={{ offset: 0, span: 0 }} wrapperCol={{ offset: 0, span: 24 }}>
                                  <Form.Item>
                                    <AntdButton className={'admin-manage-log-form-button'} style={{ marginRight: '6%' }} onClick={this.setDeleteQueueModalOpen.bind(this, index, false)}>
                                      取消
                                    </AntdButton>
                                    <AntdButton className={'admin-manage-log-form-button'} onClick={this.delQueue.bind(this, index, value)}>
                                      删除
                                    </AntdButton>
                                  </Form.Item>
                                </Form>
              ...
              <Grid.Row centered>
                ...
                <Table inverted singleLine id="patientTable">
                  <Table.Header>
                    <Table.Row>
                      <Table.HeaderCell>
                        <Button icon onClick={this.queueStateChange} color="blue" inverted>
          ...
          <div className="queue-popup" id="queue-popup">
            <div class="queue-name">
              ...
              <div className="queue-name-bottom-block">
                <Input placeholder="队列名" id="nameinput" onChange={this.handleNameChange} maxLength={12}></Input>
