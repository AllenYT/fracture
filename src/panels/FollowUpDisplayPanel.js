  ...
  async componentWillMount() {
    ...
    if (this.state.username === 'origin') {
      ...
      const getCurDataPromise = new Promise((resolve, reject) => {
        axios.post(dataConfig.getDataListForCaseId, qs.stringify(curDataParams)).then((res) => {
      ...
      const getPreDataPromise = new Promise((resolve, reject) => {
        axios.post(dataConfig.getDataListForCaseId, qs.stringify(preDataParams)).then((res) => {
      ...
      axios.post(draftConfig.getRectsForFollowAndUsername, qs.stringify(followRectsParams)).then((followRectsResponse) => {
