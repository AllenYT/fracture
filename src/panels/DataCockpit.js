...
class DataCockpit extends Component {
  ...
  visualize() {
    ...
    if (!this.isEmpty(ageD)) {
      ...
      console.log('ageTotalData1', ageTotalData1)
    ...
    ProgressChart.interval().position('item*value').color('item', '#50b0ec').shape('liquid-fill-gauge').style({
      lineWidth: 10,
      opacity: 0.5,
    })
    ...
    if (!this.isEmpty(thicknessDist)) {
      ...
      thicknessChart
        .intervalStack()
        .position('percent')
        .color('type', ['l(100) 0:#8bc6ec 1:#9599E2', 'l(100) 0:#80D0C7 1:#0093E9', 'l(100) 0:#FFD26F 1:#F79059'])
        .label('percent', {
          offset: 40,
          autoRotate: false,
          textStyle: {
    ...
    if (!this.isEmpty(benmaliD)) {
      ...
      benmaliChart
        .intervalStack()
        .position('percent')
        .color('type', ['l(100) 0:#8bc6ec 1:#9599E2', 'l(100) 0:#80D0C7 1:#0093E9', 'l(100) 0:#FF6B3B 1:#FFC100'])
        .label('percent', {
          offset: 40,
          autoRotate: false,
          textStyle: {
    ...
    if (!this.isEmpty(sexData)) {
      ...
      sexChart
        .intervalStack()
        .position('percent')
        .color('item', ['l(100) 0:#8bc6ec 1:#9599E2', 'l(100) 0:#80D0C7 1:#0093E9'])
        .label('percent', {
          offset: 25,
          autoRotate: true,
          textStyle: {
