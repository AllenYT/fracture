          ...
          <Menu className="corner-header">
            ...
            <Menu.Item className="funcolumn">
              <Button.Group>
                ...
                <Button
                  icon
                  className="funcBtn"
                  onClick={this.handleFuncButton.bind(this, "FRG")}
                  title="分块"
            ...
            <Menu.Item className="hucolumn" hidden={!MPR}>
              <Button.Group>
                <Button
                  className="hubtn"
                  onClick={this.handleFuncButton.bind(this, "LUNG")}
                  title="肺窗"
                  content="肺窗"
                ></Button>
                <Button
                  className="hubtn"
                  onClick={this.handleFuncButton.bind(this, "BONE")}
                  title="骨窗"
                  content="骨窗"
                ></Button>
                <Button
                  className="hubtn"
                  onClick={this.handleFuncButton.bind(this, "VENTRAL")}
                  title="腹窗"
                  content="腹窗"
                ></Button>
                <Button
                  className="hubtn"
                  onClick={this.handleFuncButton.bind(this, "MEDIA")}
                  title="纵隔窗"
                  content="纵隔窗"
                ></Button>
              </Button.Group>
